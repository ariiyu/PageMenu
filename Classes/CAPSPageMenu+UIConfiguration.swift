...
extension CAPSPageMenu {
    ...
    func setUpUserInterface() {
        ...
        let menuScrollView_constraint_V:Array = NSLayoutConstraint.constraints(withVisualFormat: "V:|-\(configuration.menuMarginTopToContainer)-[menuScrollView(\(configuration.menuHeight))]", options: NSLayoutConstraint.FormatOptions(rawValue: 0), metrics: nil, views: viewsDictionary)
    ...
    func configureUserInterface() {
        ...
        for controller in controllerArray {
            ...
            if configuration.useMenuLikeSegmentedControl {
                ...
                let itemWidthRect : CGRect = (titleText as NSString).boundingRect(with: CGSize(width: 1000, height: 1000), options: .usesLineFragmentOrigin, attributes: [NSAttributedString.Key.font:configuration.menuItemFont], context: nil)
